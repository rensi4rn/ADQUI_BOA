...
>>>>>>> 022b3764103641f0b85fe37ac09f95c742d9318b
  ...
  estado VARCHAR(255), 
  obs VARCHAR(1000), 
  porc_anticipo NUMERIC(3,2) DEFAULT 0, 
  porc_retgar NUMERIC(3,2) DEFAULT 0, 
  ...
  CONSTRAINT chk_tobligacion_pago__estado CHECK ((estado)::text = ANY (ARRAY[('borrador'::character varying)::text, ('registrado'::character varying)::text,('proceso'::character varying)::text, ('finalizado'::character varying)::text])), 
...
CREATE TABLE tes.tplan_pago(
    ...
    otros_decuentos numeric(19, 2) DEFAULT 0 NOT NULL,
